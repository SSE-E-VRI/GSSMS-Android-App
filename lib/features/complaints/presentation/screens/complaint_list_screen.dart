  ...
  Widget _buildListBody(ComplaintListState state) {
    ...
    if (state is ComplaintListLoaded) {
      ...
      if (complaints.isEmpty) {
        return const Center(
          child: Text('No complaints found matching criteria.'),
        );
      }
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getSeverityColor(complaint.severity).withOpacity(0.15),
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(color: _getSeverityColor(complaint.severity)),
                  ),
                  child: Text(
